...
// ── Mobile CTA ─────────────────────────────────────────────────────────────────
const MobileCTA = () => (
  <div className="md:hidden fixed bottom-4 left-4 right-4 z-50" style={{ display: 'flex', gap: '10px' }}>
    <a href="https://wa.me/[WHATSAPP_NUMBER]?text=Hi%2C%20I%20want%20to%20book%20an%20appointment%20at%20Denta%20Care"
      target="_blank" rel="noreferrer"
      className="flex items-center justify-center gap-2 text-white font-bold text-sm py-4 rounded-full shadow-2xl flex-1"
      style={{ background: '#25D366', fontFamily: 'Barlow', letterSpacing: '0.04em', boxShadow: '0 8px 24px rgba(37,211,102,0.5)', textDecoration: 'none' }}>
      💬 WHATSAPP
    </a>
    <a href="tel:[PHONE]"
      className="flex items-center justify-center gap-2 text-white font-bold text-sm py-4 rounded-full shadow-2xl flex-1"
      style={{ background: '#FF5A1F', fontFamily: 'Barlow', letterSpacing: '0.04em', boxShadow: '0 8px 24px rgba(255,87,34,0.5)' }}>
